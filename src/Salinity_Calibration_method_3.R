...
#
# Load the work space variables from the file 'HUD2010049_Prepared_Data.RData'
#
# ### load('HUD2010049_Prepared_Data.RData')
# -----------------------------------------------------------------------------
...
wd <- getwd()
print(wd)
input_file <- file.path(wd, 'Input', 'HUD2010049_Salinity_Rpt.csv')
...
#
# Compute Linear Calibration Coefficients for Primary Conductivity (3561)
#
...
#
# Compute Linear Calibration Coefficients for Secondary Conductivity (3562)
#
...
mean_cdiff1 <- mean(cdiff1, na.rm = TRUE)
abline(mean_cdiff1, 0, col = col_blue)
points(cdiff1_corr, col = col_red, pch = 20, ylim = range(-0.002,0.002))
mean_cdiff1_corr <- mean(cdiff1_corr, na.rm = TRUE)
abline(mean_cdiff1_corr, 0, col = col_red)
...
mean_sdiff1 <- mean(sdiff1, na.rm = TRUE)
abline(mean_sdiff1, 0, col = col_blue)
points(sdiff1_corr, col = col_red, pch = 20, ylim = range(-0.01,0.01))
mean_sdiff1_corr <- mean(sdiff1_corr, na.rm = TRUE)
abline(mean_sdiff1_corr, 0, col = col_red)
